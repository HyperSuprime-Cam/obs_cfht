...
class NewMegacamMapper(NewCameraMapper):
    ...
    def __init__(self, **kwargs):
        ...
        # get the location of the in-package policy (I don't know why we call it "repository" dir)
        repositoryDir = policyFile.getRepositoryPath()

        super(NewMegacamMapper, self).__init__(policy, repositoryDir=repositoryDir, **kwargs)
